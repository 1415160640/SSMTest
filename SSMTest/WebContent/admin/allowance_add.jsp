...
<body>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel">添加津贴信息</h4>
				</div>
					...
					<form class="form-horizontal" id="edit_customer_form">
						...
						<div class="form-group">
							<label for="edit_customerFrom" class="col-sm-2 control-label">金额（元/次）</label> 
								<div class="col-sm-10">
							    <input type="text" class="form-control" id="edit_customerName"  name="money" required>
							</div>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript">
		function updateCustomer() {
			$.post("<%=basePath%>addAllowance",$("#edit_customer_form").serialize(),function(data){
				alert("添加信息成功！");
