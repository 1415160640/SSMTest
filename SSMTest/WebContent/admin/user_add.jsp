...
<body>
					...
					<form class="form-horizontal" id="edit_customer_form">
						...
						<div class="form-group">
							<label for="edit_customerFrom" class="col-sm-2 control-label">账号</label> 
								<div class="col-sm-10">
							 <input type="text" class="form-control" id="edit_customerName"  name="username"required>
							</div>
						</div>
						<div class="form-group">
							<label for="edit_custIndustry" class="col-sm-2 control-label">密码</label>
						    <div class="col-sm-10">
							<input type="text" class="form-control" id="edit_customerName"  name="password" required>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="edit_linkMan"  name="address">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="edit_mobile" name="pid">
							</div>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript">
		function updateCustomer() {
			$.post("<%=basePath%>addUser",$("#edit_customer_form").serialize(),function(data){
				alert("添加职工信息成功！");
				window.location.replace("${pageContext.request.contextPath}/findUser");
			});
		}
	</script>
